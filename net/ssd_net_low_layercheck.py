    ...
    def forward(
        ...
        with tf.variable_scope("conv1") as scope:
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv1_2,
                pa_en=pa_conv1_2,
                threshold_w=tw_conv1_2,
                threshold_a=ta_conv1_2,
                begin_pruning=begin_pruning,
        ...
        with tf.variable_scope("conv2") as scope:
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv2_1,
                pa_en=pa_conv2_1,
                threshold_w=tw_conv2_1,
                threshold_a=ta_conv2_1,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv2_2,
                pa_en=pa_conv2_2,
                threshold_w=tw_conv2_2,
                threshold_a=ta_conv2_2,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
        ...
        with tf.variable_scope("conv3") as scope:
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv3_1,
                pa_en=pa_conv3_1,
                threshold_w=tw_conv3_1,
                threshold_a=ta_conv3_1,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv3_2,
                pa_en=pa_conv3_2,
                threshold_w=tw_conv3_2,
                threshold_a=ta_conv3_2,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv3_3,
                pa_en=pa_conv3_3,
                threshold_w=tw_conv3_3,
                threshold_a=ta_conv3_3,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
        ...
        with tf.variable_scope("conv4") as scope:
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv4_1,
                pa_en=pa_conv4_1,
                threshold_w=tw_conv4_1,
                threshold_a=ta_conv4_1,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv4_2,
                pa_en=pa_conv4_2,
                threshold_w=tw_conv4_2,
                threshold_a=ta_conv4_2,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv4_3,
                pa_en=pa_conv4_3,
                threshold_w=tw_conv4_3,
                threshold_a=ta_conv4_3,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
        ...
        with tf.variable_scope("conv4_3_scale") as scope:
            weight_scale = tf.Variable([20.0] * 512, trainable=training, name="weights")
            ...
            feature_layers.append(
                tf.multiply(
                    weight_scale, self.l2_normalize(inputs, name="norm"), name="rescale"
                )
            )
        ...
        with tf.variable_scope("conv5") as scope:
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv5_1,
                pa_en=pa_conv5_1,
                threshold_w=tw_conv5_1,
                threshold_a=ta_conv5_1,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv5_2,
                pa_en=pa_conv5_2,
                threshold_w=tw_conv5_2,
                threshold_a=ta_conv5_2,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
            ...
            inputs = self.conv_block_low(
                ...
                pw_en=pw_conv5_3,
                pa_en=pa_conv5_3,
                threshold_w=tw_conv5_3,
                threshold_a=ta_conv5_3,
                begin_pruning=begin_pruning,
                end_pruning=end_pruning,
                pruning_frequency=pruning_frequency,
                target_sparsity=target_sparsity,
        ...
        with tf.variable_scope("additional_layers") as scope:
            with tf.variable_scope("conv8") as scope:
                ...
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv8_1,
                    pa_en=pa_conv8_1,
                    threshold_w=tw_conv8_1,
                    threshold_a=ta_conv8_1,
                    kernel_size=1,
                    strides=(1, 1, 1, 1),
                    use_bias=True,
                    name="conv8_1",
                ...
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv8_2,
                    pa_en=pa_conv8_2,
                    threshold_w=tw_conv8_2,
                    threshold_a=ta_conv8_2,
                    kernel_size=3,
                    strides=stride,
                    use_bias=True,
                    name="conv8_2",
            ...
            with tf.variable_scope("conv9") as scope:
                ...
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv9_1,
                    pa_en=pa_conv9_1,
                    threshold_w=tw_conv9_1,
                    threshold_a=ta_conv9_1,
                    kernel_size=1,
                    strides=(1, 1, 1, 1),
                    use_bias=True,
                    name="conv9_1",
                ...
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv9_2,
                    pa_en=pa_conv9_2,
                    threshold_w=tw_conv9_2,
                    threshold_a=ta_conv9_2,
                    kernel_size=3,
                    strides=stride,
                    use_bias=True,
                    name="conv9_2",
            ...
            with tf.variable_scope("conv10") as scope:
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv10_1,
                    pa_en=pa_conv10_1,
                    threshold_w=tw_conv10_1,
                    threshold_a=ta_conv10_1,
                    kernel_size=1,
                    strides=(1, 1, 1, 1),
                    use_bias=True,
                    name="conv10_1",
                ...
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv10_2,
                    pa_en=pa_conv10_2,
                    threshold_w=tw_conv10_2,
                    threshold_a=ta_conv10_2,
                    kernel_size=3,
                    strides=(1, 1, 1, 1),
                    use_bias=True,
                    name="conv10_2",
            ...
            with tf.variable_scope("conv11") as scope:
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv11_1,
                    pa_en=pa_conv11_1,
                    threshold_w=tw_conv11_1,
                    threshold_a=ta_conv11_1,
                    kernel_size=1,
                    strides=(1, 1, 1, 1),
                    use_bias=True,
                    name="conv11_1",
                ...
                inputs = self.conv_block_low(
                    ...
                    pw_en=pw_conv11_2,
                    pa_en=pa_conv11_2,
                    threshold_w=tw_conv11_2,
                    threshold_a=ta_conv11_2,
                    kernel_size=3,
                    strides=(1, 1, 1, 1),
                    use_bias=True,
                    name="conv11_2",
        ...
        with tf.variable_scope(name):
            ...
            conv_bn_blocks.append(
                tf.layers.BatchNormalization(
                    ...
                    _scope="{}_bn1".format(name),
                    _reuse=None,
                )
            )
            conv_bn_blocks.append(
                ReLuLayer(
                    "{}_relu1".format(name), _scope="{}_relu1".format(name), _reuse=None
                )
            )
            conv_bn_blocks.append(
                tf.layers.Conv2D(
            ...
            conv_bn_blocks.append(
                tf.layers.BatchNormalization(
                    ...
                    _scope="{}_bn2".format(name),
                    _reuse=None,
                )
            )
            conv_bn_blocks.append(
                ReLuLayer(
                    "{}_relu2".format(name), _scope="{}_relu2".format(name), _reuse=None
                )
            )
    ...
    with tf.variable_scope("multibox_head"):
        ...
        for ind, feat in enumerate(feature_layers):
            loc_preds.append(
                tf.layers.conv2d(
                    feat,
                    num_anchors_depth_per_layer[ind] * 4,
                    (3, 3),
                    use_bias=True,
            ...
            cls_preds.append(
                tf.layers.conv2d(
                    feat,
                    num_anchors_depth_per_layer[ind] * num_classes,
                    (3, 3),
                    use_bias=True,
